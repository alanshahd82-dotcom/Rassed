(function () {
  ...
  function bind() {
    ...
    $("#camera-btn").addEventListener("click", () => { $("#scanner-viewport").classList.toggle("camera-on"); $("#scan-status").innerHTML = `<span class="status-dot live"></span><span>الكاميرا جاهزة — وجّهها نحو الباركود</span>`; toast("تم فتح وضع الكاميرا التجريبي.", "success"); });
